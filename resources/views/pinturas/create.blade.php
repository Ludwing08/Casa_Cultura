                  ...
                  <div class="card text-start">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="codigo" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                        <div class="col">
                          <div class="mb-3">
                            <label for="" class="form-label">Otros Códigos</label>
                            <input type="text" class="form-control" name="codigo_alternativo" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="siglo_año" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="ubicacion_firma" id="" aria-describedby="helpId" placeholder="">
                      </div>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tecnica" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="mb-3">
                            <label for="" class="form-label">Soporte</label>
                            <input type="text" class="form-control" name="soporte" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-4"> Obra en cm
                            <div class="mb-3">
                              <input type="text" class="form-control" name="alto_obra" id="" aria-describedby="helpId" placeholder="Alto">
                            </div>
                            ...
                            <div class="mb-3">
                              <input type="text" class="form-control" name="diametro_mayor_obra" id="" aria-describedby="helpId" placeholder="D.Mayor">
                            </div>

                            <div class="mb-3">
                              <input type="text" class="form-control" name="diametro_menor_obra" id="" aria-describedby="helpId" placeholder="D.Menor">
                            </div>
                          </div>
                          ...
                          <div class="col-4"> Plancha Grabado
                            <div class="row">
                              <div class="mb-3">
                                <input type="text" class="form-control" name="plancha_grabado_alto" id="" aria-describedby="helpId" placeholder="Alto">
                              </div>

                              <div class="mb-3">
                                <input type="text" class="form-control" name="plancha_grabado_ancho" id="" aria-describedby="helpId" placeholder="Ancho">
                              </div>

                              <div class="mb-3">
                                <input type="text" class="form-control" name="plancha_grabado_numero" id="" aria-describedby="helpId" placeholder="Num.">
                              </div>
                          ...
                          <div class="col-4"> Marco/Elemento
                            <div class="row">
                              <div class="mb-3">
                                <input type="text" class="form-control" name="marco_alto" id="" aria-describedby="helpId" placeholder="Alto">
                              </div>
                      ...
                      <div class="row">
                        <div class="col-4">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="forma_ingreso" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="mb-3">
                            <label for="" class="form-label">Valor USD</label>
                            <input type="number" class="form-control" name="valor" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="mb-3">
                            <label for="" class="form-label">Avalúo</label>
                            <input type="number" class="form-control" name="avaluo" id="" aria-describedby="helpId" placeholder="">
                          </div>
                        </div>
                      </div>
