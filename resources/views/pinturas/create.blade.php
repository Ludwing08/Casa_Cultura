                        ...
                        <div class="card text-start">
                          <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                          class="form-control" name="codigo" id="" aria-describedby="helpId" placeholder="" required>
                                      </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="firmado_atribuido_documento" id="" value="firmado" required>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                          class="form-control" name="tecnica" id="" aria-describedby="helpId" placeholder="" required>
                                      </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                          class="form-control" name="soporte" id="" aria-describedby="helpId" placeholder="" required>
                                      </div>
                                </div>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="card text-start">
                            <div class="card-body">
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="estado_conservacion" id="" value="bueno" required>
                                <label class="form-check-label" for="">
                                  Bueno
                                </label>
                              </div>
                    ...
                    <div class="col-6">
                        <div class="card text-start">
                            <div class="card-body">
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="estado_integridad" id="" value="completo" required>
                                <label class="form-check-label" for="">
                                  Completo
                                </label>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                          class="form-control" name="forma_ingreso" id="" aria-describedby="helpId" placeholder="" required>
                                      </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                          class="form-control" name="valor" id="" aria-describedby="helpId" placeholder="" required>
                                      </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-3">
